...
public class VenueHireSystem {
  ...
  public void printVenues() {
    ...
    // if there is nothing the venue list then print no venues
    if (numVenues == 0) {
      MessageCli.NO_VENUES.printMessage();
      return;
    }
    // if the system date is not currently set, then set system the local date
    ...
    switch (numVenues) {
      ...
      case 1:
        ...
        break;
        // case for when there are two venues in the list
      case 2:
        ...
        break;
        // case for when there are three venues in the list
      case 3:
        ...
        break;
        // case for when there are four venues in the list
      case 4:
        ...
        break;
        // case for when there are five venues in the list
      case 5:
        ...
        break;
        // case for when there are six venues in the list
      case 6:
        ...
        break;
        // case for when there are seven venues in the list
      case 7:
        ...
        break;
        // case for when there are eight venues in the list
      case 8:
        ...
        break;
        // case for when there are nine venues in the list
      case 9:
  ...
  public void createVenue(
    ...
    try {
      ...
      // this catches when the parseInt doesn't work
    } catch (NumberFormatException e) {
      MessageCli.VENUE_NOT_CREATED_INVALID_NUMBER.printMessage("capacity", "");
      return;
    }
    // Used another try-catch statement to make sure that the hire fee is a valid number
    try {
  ...
  public void setSystemDate(String dateInput) {
    // system date is the inputed date
    this.systemDate = dateInput;
    MessageCli.DATE_SET.printMessage(dateInput);

    // Everytime a new system date is set, it gets the next available date
    for (Venues venues : venue) {
      for (Booking booking : bookings) {
        // get the next date if the venue code in the list matches the input venue code
  ...
  public void viewInvoice(String bookingReference) {
    ...
    for (Services service : services) {
      if (service.bookingReference.equals(bookingReference)) {
        // if catering service is called then the variables are set for the name, catering type and
        // cost
        ...
        // if the floral service is called then the getter gets the variables for the name, floral
        // type and the cost
